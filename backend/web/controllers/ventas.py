...
def index():
    ...
    try:
        ...
        usuarios = {u['id']: u['nombre'] for u in g.db.get_all_users()}
        for venta in ventas:
            ...
            # Cambiar id_usuario por nombre
            venta['nombre_usuario'] = usuarios.get(venta['id_usuario'], f"ID {venta['id_usuario']}")
